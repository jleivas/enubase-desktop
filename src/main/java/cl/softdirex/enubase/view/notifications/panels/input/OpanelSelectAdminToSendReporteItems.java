 ...
 * @author sdx
 */
public class OpanelSelectAdminToSendReporteItems extends javax.swing.JPanel {
     ...
     */
    public OpanelSelectAdminToSendReporteItems() {
        initComponents();
        stList = load.listar("0", new User());
        try {
            autocompletar();
        } catch (SQLException | ClassNotFoundException ex) {
            Logger.getLogger(OpanelSelectAdminToSendReporteItems.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void btnLoadMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnLoadMouseClicked
        ...
        if(idUser.contains("<")){
            ...
            User user = (User)GV.searchInList(idUser, stList, new User());
            if(user!=null){
                ...
                try{
                    GV.sendReporteItemsMail(user.getEmail(),"Reporte de inventario: "+GlobalValuesVariables.ITEMS_INVENTARIO);
                }catch(Exception e){
                    CursorUtils.cursorDF(this);
