 ...
 * @author sdx
 */
public class OpanelSelectVentaToOpen extends javax.swing.JPanel {
    Boton boton = new Boton();
    /**
     * Creates new form OpanelSelectDate
     */
    public OpanelSelectVentaToOpen() {
        initComponents();
    }
    ...
    private void cargarVenta() {
        ...
        Venta venta = GV.openVentaByCod(cod);
        if(venta != null){
            try {
                ...
                Logger.getLogger(OpanelSelectVentaToOpen.class.getName()).log(Level.SEVERE, null, ex);
