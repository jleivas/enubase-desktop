...
public class OpanelMailExport extends javax.swing.JPanel {
        ...
        Boton boton = new Boton();
            ...
            switch (cboOption.getSelectedIndex()){
                case 0:
                    ...
                    OptionPane.showMsg("Debe seleccionar una opción", 
                            "No ha seleccionado una opción válida en el combo-box", 
                            JOptionPane.INFORMATION_MESSAGE);
                    break;
                case 1://todos los correos
                    CursorUtils.cursorWAIT(this);
                    XlsUtils.saveAllMails();
                    OptionPane.closeOptionPanel();
                    CursorUtils.cursorDF(this);
                    break;
                case 2://sin despacho
                    CursorUtils.cursorWAIT(this);
                    XlsUtils.saveUnDeliveredMails();
                    OptionPane.closeOptionPanel();
                    CursorUtils.cursorDF(this);
                    break;
                case 3://sin pagar
                    CursorUtils.cursorWAIT(this);
                    XlsUtils.saveDebtMails();
                    OptionPane.closeOptionPanel();
                    CursorUtils.cursorDF(this);
                    break;
                default:
    ...
    private void btnLoadMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnLoadMouseExited
        btnLoad.setIcon(new javax.swing.ImageIcon(
                getClass().getResource(Icons.getExitedIcon(btnLoad.getIcon().toString())))
        );
