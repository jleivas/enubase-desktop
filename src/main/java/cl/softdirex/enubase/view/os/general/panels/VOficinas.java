...
public class VOficinas extends javax.swing.JPanel {
     ...
     */
    public VOficinas() {
        ContentAdmin.lblTitle.setText("Registro de oficinas ("+StEntities.getLblNombreOficina()+")");
        initComponents();
        loadCompanyData();
        ...
        load();
        loadPanels(1);
        txtCompanyName.setText(GlobalValuesVariables.getCompanyName());
    ...
    private void btnEliminarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEliminarMouseClicked
        try{
            ...
            int fila = tblListar.getSelectedRow();
            String nombre = tblListar.getValueAt(fila, 0).toString();
            if(nombre.equals(StEntities.getNombreOficina())){
                OptionPane.showMsg("Oficina asignada a este equipo", "No se puede eliminar este registro porque se encuentra en uso", 2);
            }else{
    ...
    private void btnUpdateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnUpdateMouseClicked
        ...
        boolean isNameLocal = (stOficina.getNombre().equals(StEntities.getNombreOficina()))?true:false;
        if(stOficina != null){
    ...
    private void btnAsignarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAsignarMouseClicked
        try{
            ...
            if(stOficina != null){
                StEntities.setOficina(stOficina);
            }
            ContentAdmin.lblTitle.setText("Registro de oficinas ("+StEntities.getLblNombreOficina()+")");
        }catch(Exception e){
            OptionPane.showMsg("Seleccione un elemento en la tabla","Debe hacer clic sobre un elemento de la tabla,\n"
    ...
    private void cargarDatos(String listar) {
        ...
        try{
            ...
            if(tblListar.getRowCount() == 0){
                GV.showMsgOnEmptyTable(cboMostrar, txtBuscar, "Oficinas");
            }
    ...
    private void loadCompanyData() {
        txtCompanyName.setText("Nombre: "+GlobalValuesVariables.getCompanyName());
        txtCompanyGiro.setText("Giro: "+GlobalValuesVariables.getCompanyGiro());
        txtCompanyDescripcion.setText("Descripción: "+GlobalValuesVariables.getCompanyDescription());
        txtCompanyRut.setText("Rut: "+GlobalValuesVariables.getCompanyRut());
    }
}
