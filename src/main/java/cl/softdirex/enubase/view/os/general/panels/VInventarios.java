...
//        load.sincronize(new Inventario());
        ...
        String title = "Inventarios "+GlobalValuesVariables.getInventarioName()+"(Ningún inventario asignado a este equipo)";
        try {
            if(load.get(GlobalValuesVariables.getInventarioName(),0, new Inventario()) != null){
                title = "Inventarios ("+GlobalValuesVariables.getInventarioName()+" asignado a este equipo)";
            }
    ...
    private void btnModificarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnModificarMouseClicked
        cWT();
        boolean isLocal = (stInventario.getNombre().toLowerCase().equals(GlobalValuesVariables.getInventarioName().toLowerCase()))?
                true:false;
        ...
        if(isLocal){
            GlobalValuesVariables.setInventarioLocal(stInventario.getNombre());
            ContentAdmin.lblTitle.setText("Inventarios ("+GlobalValuesVariables.getInventarioName()+" asignado a este equipo)");
        }
        cargarDatos("0");
        cDF();
    ...
    private void btnAsignarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAsignarMouseClicked
        try{
            ...
            if(OptionPane.getConfirmation("Confirmar inventario", "¿Estas seguro que "+nombre+" es el inventario correcto para este equipo?\n"
                    ...
                    + "genere una nueva venta.", 2)){
                GlobalValuesVariables.setInventarioLocal(nombre);
    ...
    private void cargarDatos(String listar) {
        ...
        try{
            ...
            if(tblListar.getRowCount() == 0){
                GV.showMsgOnEmptyTable(cboMostrar, txtBuscar, "Inventarios");
            }
