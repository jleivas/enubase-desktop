...
import cl.softdirex.enubase.bd.RmBd;
...
public class Remote implements InterfaceSync{
    private static String className = Remote.className;
    @Override
    public boolean add(Object objectParam) {
        ...
        try{
            ...
            if(objectParam instanceof Venta){
                ...
                if (object != null) {
                    PreparedStatement consulta = RmBd.obtener().prepareStatement("SELECT ven_id FROM venta WHERE ven_id='" + object.getCod() + "'");
            ...
            if(objectParam instanceof Detalle){
                ...
                if (object != null) {
                    PreparedStatement consulta = RmBd.obtener().prepareStatement("SELECT det_id FROM detalle WHERE det_id='" + object.getCod() + "'");
                    ResultSet datos = consulta.executeQuery();
                    while (datos.next()) {
                        RmBd.cerrar();
                        return update(object);
            ...
            if(objectParam instanceof Item){
                ...
                if (object != null) {
                    PreparedStatement consulta = RmBd.obtener().prepareStatement("SELECT itm_id FROM item WHERE itm_id= '" + object.getCod()+ "'");
                    ResultSet datos = consulta.executeQuery();
                    while (datos.next()) {
                        RmBd.cerrar();
                        return update(object);
            ...
            if(objectParam instanceof Proveedor){
                ...
                if (object != null) {
                    PreparedStatement consulta = RmBd.obtener().prepareStatement("SELECT pro_id FROM proveedor WHERE pro_id='" + object.getCod()+ "'");
                    ResultSet datos = consulta.executeQuery();
                    while (datos.next()) {
                        RmBd.cerrar();
                        return update(object);
    ...
    public boolean update(Object objectParam) {
        ...
        try{
            ...
            if(objectParam instanceof Venta){
                Venta object = (Venta)objectParam;
                PreparedStatement consulta = RmBd.obtener().prepareStatement("SELECT * FROM venta WHERE ven_id='" + object.getCod() + "'");
                ResultSet datos = consulta.executeQuery();
                while (datos.next()) {
            ...
            if(objectParam instanceof Detalle){
                Detalle object = (Detalle)objectParam;
                PreparedStatement consulta = RmBd.obtener().prepareStatement("SELECT * FROM detalle WHERE det_id='" + object.getCod()+"'");
                ResultSet datos = consulta.executeQuery();
                while (datos.next()) {
            ...
            if(objectParam instanceof Item){
                Item object = (Item)objectParam;
                PreparedStatement consulta = RmBd.obtener().prepareStatement("SELECT * FROM item WHERE itm_id='" + object.getCod()+ "'");
                ResultSet datos = consulta.executeQuery();
                while (datos.next()) {
            ...
            if(objectParam instanceof Proveedor){
                Proveedor object = (Proveedor)objectParam;
                PreparedStatement consulta = RmBd.obtener().prepareStatement("SELECT * FROM proveedor WHERE pro_id='" + object.getCod()+ "'");
                ResultSet datos = consulta.executeQuery();
                while (datos.next()) {
