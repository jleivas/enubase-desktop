 ...
 * @author Lenovo G470
 */
public class Proveedor extends SyncStringId{
    ...
    public Proveedor(String rut, String nombre, String telefono, String email, String web, String direccion, String comuna, String ciudad, int estado, Date lastUpdate, int lastHour) {
        setCod(rut);
        setNombre(nombre);
